...
from .prompts import product_description_template, web_searching_template, enviromental_suggestions, health_analysis_template
    ...
    try:
        ...
        try:
            ...
            pros_and_cons_health = getOutPutInFormat(
                model,
                health_analysis_template.render(
                    product_name=product_details["product_name"],
                    product_description=product_details["product_description"],
                    ingridients_used=product_details["ingridients_used"],
